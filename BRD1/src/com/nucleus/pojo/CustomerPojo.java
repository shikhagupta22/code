...
public class CustomerPojo extends Person
{
	
	private String custAd2,custPinCode,custEmail,custPrimaryContactPerson,custRecordStatus,custFlag,custCreateDate,custCreatedBy,custModifiedDate,custModifiedBy,custAuthorizedDate,custAuthorizedBy;
